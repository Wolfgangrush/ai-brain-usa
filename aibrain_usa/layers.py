#!/usr/bin/env python3
"""
layers.py — 4-Layer Memory Stack for brain
===================================================
...
"aibrain_usa_drawers") and ~/.aibrain-usa/identity.txt.
"""
...
class Layer0:
    ...
    Reads from ~/.aibrain-usa/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.aibrain-usa/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = (
                "## L0 — IDENTITY\nNo identity configured. Create ~/.aibrain-usa/identity.txt"
            )
...
class MemoryStack:
    ...
    def __init__(self, palace_path: str = None, identity_path: str = None):
        cfg = BrainConfig()
        self.palace_path = palace_path or cfg.palace_path
        self.identity_path = identity_path or os.path.expanduser("~/.aibrain-usa/identity.txt")
