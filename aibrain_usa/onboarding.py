...
Usage:
    python3 -m aibrain_usa.onboarding
    or: brain init
"""

from pathlib import Path
from aibrain_usa.entity_registry import EntityRegistry
from aibrain_usa.entity_detector import detect_entities, scan_for_detection
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from aibrain_usa.entity_registry import COMMON_ENGLISH_WORDS
...
""")
    ...
    print("\n  entity-aliasing entity registry: ~/.aibrain-usa/alias_entities.md")
    print("  Critical facts bootstrap: ~/.aibrain-usa/critical_facts.md")
