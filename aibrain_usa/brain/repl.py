"""aibrain_usa.brain.repl — terminal front door for the brain.

A small, dependency-free Read–Eval–Print Loop that talks to the brain's
:class:`aibrain_usa.brain.router.think` function. The user types a
...
from aibrain_usa.brain.router import think
from aibrain_usa.brain import memory
...
_BANNER = (
    "aibrain_usa brain — terminal front door\n"
