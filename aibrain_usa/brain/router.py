...
import importlib
from aibrain_usa.brain.intents import Intent, AGENT_FOR_INTENT
...
def route(intent: Intent, payload: str) -> dict:
    ...
    full_module = f"aibrain_usa.agents.{agent_module_name}"
    try:
...
def think(text: str) -> dict:
    ...
    try:
        from aibrain_usa.brain import specialists
