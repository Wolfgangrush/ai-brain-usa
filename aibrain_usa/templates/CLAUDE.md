...
> This file was generated by `aibrain-usa init`. It tells the AI (Claude / Gemini / DeepSeek / local model) how this firm works. Edit it as your practice evolves — your edits survive `aibrain-usa update`.
...
Add your own rules below. They survive `aibrain-usa update`.
