...
```bash
python3 -m aibrain_usa reception   # greet + systems-check + memory + recap
python3 -m aibrain_usa ask "<q>"   # route one query through the brain
python3 -m aibrain_usa chat        # interactive REPL
python3 -m aibrain_usa recap       # recent-session retrospective memory
```
