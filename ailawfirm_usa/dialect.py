...
Adapted for brain: works standalone on plain text and ChromaDB drawers.
...
from .stopwords import STOPWORDS as _STOP_WORDS
...
# _STOP_WORDS is imported from ailawfirm_usa.stopwords (single source of
# truth, shared with entity_detector.py). The old inline set that used to
# live here was removed; see stopwords.STOPWORDS for the full union.
...
class Dialect:
    ...
    # === PLAIN TEXT COMPRESSION (new for brain) ===
    ...
    def compress(self, text: str, metadata: dict = None) -> str:
        ...
        This is the primary method for brain: takes any text content
