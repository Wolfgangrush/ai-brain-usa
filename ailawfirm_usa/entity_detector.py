...
Used by brain init before mining begins.
...
# STOPWORDS is imported from ailawfirm_usa.stopwords (single source of truth,
# shared with dialect.py). The old inline set that used to live here was
# removed; see stopwords.STOPWORDS for the full union.
