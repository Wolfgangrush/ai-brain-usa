"""
knowledge_graph.py — Temporal Entity-Relationship Graph for Brain
=====================================================================
...
Usage:
    from ailawfirm_india.knowledge_graph import KnowledgeGraph
...
DEFAULT_KG_PATH = os.path.expanduser("~/.ailawfirm-usa/knowledge_graph.sqlite3")
