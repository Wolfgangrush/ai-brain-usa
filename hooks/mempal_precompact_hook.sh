#!/bin/bash
# BRAIN PRE-COMPACT HOOK — Emergency save before compaction
#
...
# Set BRAIN_DIR below if you want the hook to auto-ingest before compaction.
...
# Optional: run brain ingest synchronously so memories land before compaction
